const siteTitle = 'PLEASE SET ME'
const siteDescription = 'PLEASE SET ME'
const siteLogo = '/img/furniture/logo.svg'
const siteLongTitle = 'PLEASE SET ME'
const copyright = 'Copyright © 2018. Aerian Studios LLC'
const manifestShortName = 'AerianStudios'
